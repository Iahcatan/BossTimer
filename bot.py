...
NOTICE_BF_PATCH_VERSION = "V139_BACKGROUND_REST_RATE_GUARD_FIX_2026-09-23"
...
# V139: all non-essential/background REST traffic shares a conservative minimum
# spacing. This protects the process from repeated API-rate pressure without changing
# command/interaction REST or any Voice/TTS path. Discord-provided Retry-After remains
# the authority when a 429 is actually returned.
discord_background_rest_min_interval = max(15.0, float(os.environ.get("DISCORD_BACKGROUND_REST_MIN_INTERVAL", "15.0")))
