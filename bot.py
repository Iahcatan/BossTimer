...
NOTICE_BF_PATCH_VERSION = "V103_FCM_PUSH_ENGLISH_2026-09-13"
...
def web_push_subscribe_api():
    ...
    try:
        ...
        if requested_language not in {"th", "en"}:
