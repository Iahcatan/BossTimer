...
NOTICE_BF_PATCH_VERSION = "V149_DISCORD_GATEWAY_STARTUP_RESTRICTION_GUARD_FIX_2026-09-24"
...
discord_background_rest_long_recovery_quiet_seconds = max(120.0, float(os.environ.get("DISCORD_BACKGROUND_REST_LONG_RECOVERY_QUIET", "300")))
