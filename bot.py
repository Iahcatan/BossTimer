...
NOTICE_BF_PATCH_VERSION = "V86_ATTENDANCE_HISTORY_INDIVIDUAL_BUTTON_FIX_2026-09-10-R1"
...
def attendance_data_api():
    ...
    try:
        ...
        # V85: authoritative individual attendance aggregation on the server.
        individual_members = {}
        ...
        print(f"📊 Attendance individual snapshot | members={len(individual_members)} | entries={sum(len(m.get('entries', [])) for m in individual_members.values())}", flush=True)
        return _api_json({
            'success': True,
